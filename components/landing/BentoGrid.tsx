        ...
        <div className="flex gap-1 pr-1">
          {carouselCycles.map((_, i) => (
            <button
              ...
              className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${i === cycleIndex ? "bg-blue-500 w-3" : "bg-slate-300"
                }`}
            />
          ))}
        </div>
          ...
          >
            {currentCycle.map((item, i) => (
              ...
              >
                ...
                <span className="text-[10px] text-blue-600 font-semibold bg-blue-50 px-2 py-0.5 rounded-md border border-blue-100/80">
                  {item.category}
                </span>
              </div>
            ))}
...
function MBSBillingCardInline() {
  ...
  return (
    <motion.div
      ...
      className="col-span-12 sm:col-span-6 lg:col-span-5 relative bg-gradient-to-br from-blue-50 to-sky-50/80 dark:from-[#1B212C] dark:to-[#1E2835] rounded-3xl p-5 lg:p-6 overflow-hidden cursor-pointer border border-blue-200/50 dark:border-[rgba(96, 165, 250,0.15)] shadow-[0_4px_20px_rgb(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.25)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:hover:shadow-[0_8px_30px_rgba(0,0,0,0.35)] hover:border-blue-300/60 dark:hover:border-[rgba(96, 165, 250,0.30)] active:scale-[0.99] transition-all duration-300"
    >
      {/* Decorative circles */}
      <div className="absolute -bottom-16 -right-16 w-48 h-48 bg-blue-200/30 rounded-full blur-2xl dark:opacity-0 transition-opacity" />
      <div className="absolute top-4 right-4 w-24 h-24 border border-blue-200/40 rounded-full dark:opacity-0 transition-opacity" />
      <div className="absolute top-10 right-10 w-14 h-14 border border-blue-200/30 rounded-full dark:opacity-0 transition-opacity" />
      ...
      <div className="relative z-10">
        ...
        <p className="font-sans text-base md:text-lg font-normal leading-relaxed text-slate-600 mb-5">
          Interactive <span className="font-medium text-blue-600">item number explorer</span> with real-world GP scenarios.
        </p>
          ...
          <div className="relative mb-3">
            <div
              className={`flex-1 h-9 rounded-lg flex items-center px-3 transition-all duration-200 ${
                isFocused
                  ? "bg-white border-2 border-blue-400 ring-4 ring-blue-100"
              ...
              {showResult && (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className="inline-flex items-center px-2.5 py-1 rounded-lg bg-blue-500 text-white text-xs font-bold">
                      Item 2715
                    </span>
                    <span className="text-sm font-semibold text-sky-600">$100.20 Rebate</span>
                  </div>
                  ...
                  <button
                    className={`w-full py-2 rounded-lg text-xs font-medium transition-all duration-200 flex items-center justify-center gap-1.5 ${
                      isButtonHovered
                        ...
                        : "bg-transparent text-blue-600 border border-slate-200 hover:bg-blue-50"
                    }`}
                  >
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-2 min-w-0">
                      <span className={`text-xs font-bold px-1.5 py-0.5 rounded ${item.active ? "bg-blue-500 text-white" : "bg-slate-200 text-slate-600"}`}>{item.code}</span>
                      <span className="text-xs text-slate-600 truncate">{item.label}</span>
                    </div>
                    <span className={`text-xs font-semibold flex-shrink-0 ${item.active ? "text-sky-600" : "text-slate-400"}`}>{item.fee}</span>
                  </div>
                ))}
              </div>
            )}
  ...
  return (
    ...
    >
      <div className="relative z-10">
        ...
        <p className="font-sans text-base md:text-lg font-normal leading-relaxed text-slate-600 mb-5">
          <span className="font-medium text-blue-600">Copy-paste templates</span> for common GP presentations. Consult better, miss less.
        </p>
          ...
          <div className="space-y-2.5 font-mono">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <span className="text-xs font-semibold text-blue-600">Hx:</span>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <span className="text-xs font-semibold text-blue-600">O/E:</span>
...
function AdaptiveExamPrepCardInline() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-20 -right-20 w-[300px] h-[300px] bg-gradient-to-br from-blue-500/25 via-blue-400/15 to-transparent rounded-full blur-[60px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[200px] h-[200px] bg-gradient-to-tr from-sky-500/10 to-transparent rounded-full blur-[40px] pointer-events-none" />
      ...
      <div className="relative z-10">
        ...
        <p className="font-sans text-base md:text-lg font-normal leading-relaxed text-slate-400 max-w-md mb-6">
          Dynamic mock exams for <span className="text-blue-400 font-medium">AKT</span> and <span className="text-blue-400 font-medium">KFP</span>. The platform learns your weak spots and prioritizes them—every minute counts.
        </p>
        ...
        <div className="bg-white/[0.07] backdrop-blur-sm rounded-2xl p-4 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-[10px] text-blue-400 font-medium">+12%</div>
            </div>
          </div>
          ...
          <div className="space-y-2.5">
            {[
              { label: "Cardiology", progress: cardiologyProgress, color: "bg-blue-400" },
              { label: "Respiratory", progress: respiratoryProgress, color: "bg-sky-400" },
                    ...
                    {showRewardBubble && (
                      <motion.span
                        ...
                        className={`absolute right-0 text-[10px] font-bold px-1.5 py-0.5 rounded border z-10 ${
                          bubbleType === "up"
                            ? "text-blue-400 bg-blue-950/90 border-blue-500/30 shadow-[0_0_10px_rgba(66, 139, 225,0.2)]"
          ...
          <div className="pt-3 mt-3 border-t border-white/10">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[9px] text-blue-400 font-medium">View details →</span>
            </div>
                  ...
                  >
                    <motion.div
                      ...
                      className={`w-full rounded-sm ${
                        item.isToday
                          ? "bg-blue-500 shadow-[0_0_8px_rgba(66, 139, 225,0.4)]"
                          : "bg-slate-700/50"
                      }`}
                      style={{ minHeight: "2px" }}
                    />
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3 border-b border-slate-800/60 pb-2">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-bold text-blue-400 tracking-wider uppercase">{currentQuestion.title}</span>
                </div>
                ...
                {currentQuestion.options.map((opt) => {
                  ...
                  if (isSelected) {
                    if (currentQuestion.isCorrect) {
                      rowStyle = "bg-sky-500/10 border-sky-500 text-sky-400 font-semibold shadow-[0_0_12px_rgba(16,185,129,0.15)]";
                      circleStyle = "border-sky-500 text-sky-400 bg-sky-500/10";
                      showIcon = "check";
                    } else {
  ...
  return (
    <section id="tools" className="pt-6 pb-10 lg:pt-8 lg:pb-14 bg-transparent relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <span className="inline-flex items-center gap-2 text-sm font-semibold text-blue-600 dark:text-[#60A5FA] mb-3">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-start gap-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="font-sans text-base md:text-lg font-normal leading-relaxed text-slate-600 mb-4">
                  <span className="font-medium text-blue-600">300+ conditions</span> catalogued. Browse, search, and revise on the go.
                </p>
                    ...
                    <div key={rowIdx} className="flex gap-2">
                      {row.map((condition) => (
                        <motion.div
                          ...
                          className="group flex-1 min-w-0 px-2.5 py-1.5 rounded-xl text-xs font-medium flex items-center cursor-pointer bg-white border border-slate-200/80 text-slate-700 shadow-sm hover:shadow-md hover:border-blue-200 hover:bg-blue-50/60 transition-all duration-200 active:scale-[0.96]"
                        >
                          <span className="group-hover:text-blue-700 transition-colors truncate">{condition.name}</span>
                        </motion.div>
                      ))}
                    </div>
                  ))}
