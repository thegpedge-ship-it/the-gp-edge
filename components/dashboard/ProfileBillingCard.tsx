...
export default function ProfileBillingCard({
  ...
  return (
    <div className="p-6 h-full flex flex-col md:flex-row justify-between gap-6 md:gap-8">
      ...
      {(showDownloadInvoice || (showCancelSubscription && isRecurring)) && (
        <div className="md:mt-0 flex flex-col gap-2.5 w-full md:w-64 shrink-0 md:self-center">
          {showDownloadInvoice && (
            <button
              type="button"
