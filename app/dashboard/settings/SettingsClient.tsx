...
export default function SettingsClient({
  ...
  return (
    <div className="flex flex-col gap-4 pb-6">
        ...
        <FadeIn delay={0.10}>
          <PageCard className="bg-white border border-slate-200 rounded-2xl shadow-sm flex flex-col">
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              {/* Danger Zone */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-red-100 dark:border-red-950/40 bg-red-50/10 dark:bg-red-950/10 mt-2">
      ...
      <FadeIn delay={0.12}>
        <PageCard className="bg-white border border-slate-200 rounded-2xl shadow-sm">
          <ProfileBillingCard
