    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="font-serif text-2xl lg:text-3xl font-normal text-white tracking-tight leading-tight mb-1">Question Management</h1>
          <p className="text-sm text-teal-100 font-light">{questions.length} questions in bank</p>
        </div>
        <div className="relative z-10 flex items-center gap-3">
          <button className="px-4 py-2.5 bg-white/10 backdrop-blur-md text-sm font-medium text-white border border-white/20 rounded-full hover:bg-white/20 transition-all flex items-center gap-2">
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-end gap-3 pt-2">
                    ...
                    <button onClick={() => setShowAddModal(false)} className="px-4 py-2.5 text-sm font-semibold text-white bg-teal-500 rounded-xl hover:bg-teal-600 transition-all shadow-sm shadow-teal-500/20">Save as Draft</button>
                  </div>
                </div>
              </div>
            </motion.div>
