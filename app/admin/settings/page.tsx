  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
      <AdminPageHeader
        ...
        subtitle="Feature flags, system storage metrics, and scheduled background operations"
        ...
        >
          ...
          <div>
            ...
            <p className="mt-0.5 opacity-90">
              You are signed in under the <strong>Viewer</strong> role. You have full read-only access to all sections and data, but toggling feature flags or scheduled jobs is restricted.
            </p>
          </div>
        </motion.div>
      )}
