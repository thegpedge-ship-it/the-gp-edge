  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      ...
      >
        ...
        <h2 className="font-serif text-xl text-slate-900 mb-2">Something went wrong</h2>
        <p className="text-sm text-slate-500 font-light mb-6">{error.message || "An unexpected error occurred in the admin panel."}</p>
        <button
          onClick={() => reset()}
