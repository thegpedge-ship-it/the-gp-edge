                    ...
                    {uploadState === "idle" && (
                      <>
                        ...
                        >
                          ...
                          <p className="text-[10px] text-slate-400 mt-0.5 font-sans">Supports PDF, DOCX, DOC, PNG, JPG, TIFF, WebP · Images are processed with OCR · Multiple files supported</p>
                        </div>

                        <div className="flex justify-start pt-2">
                          <button onClick={() => setModalStep("select")} className="px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-semibold text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer bg-transparent">Back</button>
                        </div>
                      </>
                    )}
