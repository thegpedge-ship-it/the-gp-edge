...
const tempDir = path.join(__dirname, 'temp_akt_100_docx');
...
for (let i = 1; i <= 100; i++) {
  questionsXml += `
    ...
    <w:p><w:r><w:rPr><w:color w:val="64748B"/><w:i/></w:rPr><w:t>E) [Enter Option E text here (optional)]</w:t></w:r></w:p>
  ...
  <w:body>
    ...
    <w:p>
      ...
      <w:r>
        ...
        <w:t>Applied Knowledge Test (AKT) Question Authoring Template (100 Questions)</w:t>
      </w:r>
    </w:p>
    ...
    <w:p>
      ...
      <w:r>
        ...
        <w:t>INSTRUCTIONS FOR AKT QUESTION AUTHORS:</w:t>
      </w:r>
      <w:r><w:br/></w:r>
      <w:r>
      ...
      <w:r>
        <w:rPr><w:sz w:val="20"/><w:color w:val="334155"/></w:rPr>
        <w:t>• Fill in your questions under 'Stem:', 'Lead-in:', 'Options:', 'Correct Answer:', 'Why Correct:', 'Distractor Rationales:', 'Knowledge Bank:', and 'Clinical Pearl:'.</w:t>
      </w:r>
      <w:r><w:br/></w:r>
      <w:r>
        <w:rPr><w:sz w:val="20"/><w:color w:val="334155"/></w:rPr>
...
try {
  ...
  console.log('Successfully generated 100-question AKT template (Proper Paragraphs):', outputPath, 'Size:', fs.statSync(outputPath).size);
} catch (e) {
