...
function ContentEditorContent() {
  ...
  const [author, setAuthor] = useState("Dr. Arun Mehta");
  ...
  return (
    <>
      ...
      <motion.div variants={itemVariants} className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl rounded-2xl border border-teal-200/40 dark:border-teal-900/40 shadow-md shadow-slate-200/30 relative z-20 no-print sticky top-14">
